...
import {easyProblemState} from '../atom/easyProblemAtom'
...
const EasyPage = () => {
  const newBackgroundColor = '#00D4FF'
  const newHeight = '690%'

  const [problem, setProblem] = useRecoilState(easyProblemState)
  ...
  useEffect(() => {
    ...
    fetchSentence('easy') // fetchData 함수 호출
