...
import {normalProblemState} from '../atom/normalProblemAtom'
...
const NormalPage = () => {
  const newBackgroundColor = '#FFA500'
  const newHeight = '690%'

  const [problem, setProblem] = useRecoilState(normalProblemState)
  ...
  useEffect(() => {
    ...
    fetchSentence('normal') // fetchData 함수 호출
